...
<template>
  <div class="relative shadow-lg">
    <div
      class="absolute inset-x-0 w-full p-4 overflow-hidden rounded-t-md bg-ligthModeColors-background dark:bg-darkModeColors-background">
      <p>
        {{ film.name }}
      </p>
    </div>
    ...
    <img class="h-[100%] w-full rounded-md object-cover bg-center bg-no-repeat md:h-[500px]" :src="film.image" />
  </div>
</template>
